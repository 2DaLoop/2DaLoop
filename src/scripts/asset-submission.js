...
//     // populateData(data) {
//     //     const quantityInputs = document.querySelectorAll(inputs);
...
//             // Clear all quantity and age input fields
//             const inputs = document.getElementById('telecom-quantity').value;
//             inputs.forEach(input => {
//                 inputs.value = '';
...
//             // const existingMsg = document.querySelector('.inventory-message');
//             // if (existingMsg) existingMsg.remove();

//             // // Create and show a new message
//             // const messageDiv = document.createElement('div');
//             // messageDiv.className = 'inventory-message success-message';
//             // messageDiv.textContent = 'All data has been cleared successfully!';
...
// // Clear all user input in quantity and age fields
// function clearAllUserInput() {
//     // Select all quantity and age input fields
//     const inputs = document.querySelectorAll('.quantity-input, .age-input');
//     inputs.forEach(input => {
//         input.value = '';
//         input.style.borderColor = '#d1d5db'; // Optionally reset border color
//     });
// }

// // Example: Attach to Clear All button
// document.addEventListener('DOMContentLoaded', function () {
//     const clearBtn = document.querySelector('.clear-btn');
//     if (clearBtn) {
//         clearBtn.addEventListener('click', clearAllUserInput);
//     }
// });
